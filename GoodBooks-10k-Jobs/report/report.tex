...
Il dataset per l'esame si trova sià nel nodo \texttt{vclust9} nella home di \texttt{lvalgimigli} %%todo add soro
all'indirizzo \texttt{lvalgimigli@isi-vclust9.csr.unibo.it:./exam/dataset/}
